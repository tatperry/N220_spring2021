...
//
//
// creating and calling for the canvas function
...
// making the bricks dissapear when they are hit with ball
const bricks = [];
...
//
// Ball will start in the middle and bounce anywhere
function drawBall() {
  $.beginPath();
...
// styles for the paddle and where it moves
function drawPaddle() {
  $.beginPath();
...
// bringing everything on to screen in canvas
function drawAll() {
  $.clearRect(0, 0, w, h);
